export const portfolioData = {
    ...
    about: {
        ...
        community: "Lead organizer of Nandha Hackathons & Symposia, uniting 1000+ students for innovation."
    },
    skills: {
        technical: [
        ...
        soft_skills: [
            "Clear Communication", "Problem Solving", "Leadership", "Project Management", "Critical Thinking"
        ]
    },
    experience: [
        {
            ...
            points: [
                ...
                "Participated in Agile sprint cycles and code reviews."
            ]
        },
        {
            ...
            points: [
                ...
                "Wrote unit tests and performed debugging to improve stability."
            ]
        },
        {
            role: "Organizer",
            ...
            points: [
                ...
                "Established partnerships with industry mentors and sponsors.",
                "Managed cross-functional teams of volunteers."
            ]
        }
    ],
    projects: [
        {
            ...
            highlights: [
                "Interactive node-based architecture diagrams.",
                "AI-powered tech stack detection and API mapping.",
                "Export as SVG/PNG/PDF and source code ZIP download."
            ],
            link: "https://repolens-9hr0.onrender.com/"
        },
        {
            ...
            highlights: [
                ...
                "Real-time bookmark sync via Supabase Realtime.",
                "Glassmorphism UI with Framer Motion animations."
            ],
            link: "https://smart-bookmark-chi.vercel.app/"
        },
        {
            name: "Money Manager",
            ...
            highlights: [
                ...
                "RESTful API backend with MongoDB Atlas integration."
            ],
            link: "https://money-manager-indrakumar.vercel.app/"
        },
        {
            ...
            highlights: [
                "Instant AI-generated personalized responses for users.",
                "Admin panel with AI summaries and action insights."
            ],
